    ...
    >
      ...
      <div className="relative z-10 space-y-4 md:space-y-5 lg:space-y-6 mb-6 md:mb-7 lg:mb-9 max-w-md md:max-w-[500px] lg:max-w-[588px] mt-16 md:mt-[120px] lg:mt-[160px] px-4">
        <div className="flex justify-center mb-4 md:mb-6">
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/%E6%9C%AA%E5%91%BD%E5%90%8D%E7%9A%84%E8%AE%BE%E8%AE%A1%20%2811%29-vYpj5aHF6e7Eme1ygtXTqsENGMiTeS.png"
            alt="CLOV Logo"
            className="w-16 h-16 md:w-20 md:h-20 lg:w-24 lg:h-24"
          />
        </div>
        <h1 className="text-foreground text-3xl md:text-4xl lg:text-6xl font-semibold leading-tight">CLOV</h1>
        <p className="text-muted-foreground text-base md:text-base lg:text-lg font-medium leading-relaxed max-w-lg mx-auto">
          Submit any social media influencer and get comprehensive AI analysis with cryptocurrency market cap estimates.
          Our advanced algorithms analyze multi-faceted data to provide accurate valuations.
        </p>
      </div>
