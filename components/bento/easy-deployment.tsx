...
const DeploymentEasy: React.FC<DeploymentEasyProps> = ({ width = "100%", height = "100%", className = "" }) => {
  ...
  const logLines = [
    ...
    '[16:37:29.945] Running "clov build"',
    "[16:37:30.561] CLOV CLI 44.5.0",
    ...
    "[16:37:58.585] ○ (Static) prerendered as static content",
    "[16:38:01.099] Build Completed in /clov/output [30s]",
