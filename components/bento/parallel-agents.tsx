...
interface AIAnalysisAgentsProps {
  className?: string
}

const AIAnalysisAgents: React.FC<AIAnalysisAgentsProps> = ({ className = "" }) => {
  ...
  const agents = [
    {
      ...
      tokens: "15k tokens",
      model: "claude-4",
      branch: "clov/engagement-analysis",
    },
    {
      icon: <RefreshIcon />,
      title: "Market cap estimation",
      tokens: "20k tokens",
      model: "gpt-4",
      branch: "clov/market-valuation",
    },
    {
      icon: <SparklesIcon />,
      ...
      tokens: "12k tokens",
      model: "claude-4",
      branch: "clov/sentiment-tracking",
    },
  ]
  ...
  return (
    <div
      ...
      role="img"
      aria-label="AI analysis agents working on different valuation tasks simultaneously"
    >
...
export default AIAnalysisAgents
