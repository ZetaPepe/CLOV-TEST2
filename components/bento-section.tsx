...
export function BentoSection() {
  const cards = [
    {
      title: "AI-powered influencer analysis.",
      description: "Get real-time, smart insights for better valuations.",
      Component: AiCodeReviews,
    },
    {
      title: "Real-time market analysis",
      description: "Track, analyze, and instantly preview token valuations.",
    ...
    },
    {
      ...
      description: "Go from code to live deployment instantly.",
      ...
      <div className="w-full py-8 md:py-16 relative flex flex-col justify-start items-start gap-6">
        ...
        <div className="self-stretch py-8 md:py-14 flex flex-col justify-center items-center gap-2 z-10">
          <div className="flex flex-col justify-start items-center gap-4">
            ...
            <p className="w-full max-w-[600px] text-center text-foreground/70 text-lg md:text-xl font-medium leading-relaxed">
              Ask your AI Agent for real-time collaboration, seamless integrations, and actionable insights to
              streamline your influencer token valuations.
            </p>
          </div>
        </div>
